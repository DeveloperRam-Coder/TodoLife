...
export const TaskProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  let taskIdCounter = "💡"; // This should ideally be outside of the addTask function to keep track across multiple calls

  const addTask = (task: Omit<Task, "id" | "createdAt">) => {
    // Create a new task with sequential ID and the current date
    const newTask: Task = {
      ...task,
      id: `TASK-${taskIdCounter}`, // Use the sequential task ID
